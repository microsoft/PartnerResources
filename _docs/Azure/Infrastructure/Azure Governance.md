...
* [**MS Docs:** Azure Automanage Machine Configuration](https://learn.microsoft.com/en-us/azure/governance/machine-configuration/overview)
...
### Examples for Deploying Azure Policies
...
* [**MS Docs:** Use Azure Policy to implement governance controls for Azure Cosmos DB](https://docs.microsoft.com/en-us/azure/cosmos-db/policy)
...
* [**GitHub:** Azure Lighthouse Samples](https://github.com/Azure/Azure-Lighthouse-samples)
