...
Welcome to the Phone bucket in the Teams Academy. Here we will dig into all things related to Teams Phone, which is a lot! Direct routing, phone plans, operator connect, and all the fun stuff that entails: networking, migration, Session Border Controllers, voice policies/routing, E164, SIP, CODECS, 911, and the list goes on and on! 
