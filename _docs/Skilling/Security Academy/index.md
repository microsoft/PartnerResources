...
A new administration is in office, and that means many federal employees are onto new careers -- including Jen Easterly, the former and esteemed  Director of CISA. It's notable (and shouldn't come as a surprise to abslutely anyone) that in her final days, she wrote about the increasing threats we face from the PRC and MSS, which you can read about **[here](https://www.cisa.gov/news-events/news/strengthening-americas-resilience-against-prc-cyber-threats).**
...
If you're looking for an easier way to consume Microsoft Sentinel extensive's GitHub repository, **[this](https://analyticsrules.exchange/)** is a helpful catalog.
