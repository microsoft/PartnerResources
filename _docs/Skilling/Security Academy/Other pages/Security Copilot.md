...
If you're a member of the **[Microsoft Copilot for Security Customer Connection Program (CCP)](https://www.aka.ms/prseccom)**, join our weekly Copilot for Security Skilling and Readiness events:
...
##### Also explore the [Copilot for Security Partner Playbook](https://aka.ms/CfSpartnerPlaybook)
...
<table>
  ...
  <tr style="vertical-align:top">
   <td><a href="https://youtu.be/EZrKUtxFnGU?si=dWxf3UePboDB8tKU"><img src="https://img.youtube.com/vi/EZrKUtxFnGU/maxresdefault.jpg" alt="Copilot for Security Pricing" width="400" height="400"></a></td>
    <td><a href="https://youtu.be/EZrKUtxFnGU?si=dWxf3UePboDB8tKU"><b>Copilot for Security Pricing</b></a><br><br>Short on time? Learn about Copilot for Security’s pricing model in just 10 minutes, including how to provision, scale, and manage Security Compute Units (SCUs). Discover what you can do today, along with valuable onboarding tips.</td>
  </tr>
  <tr style="vertical-align:top">
   <td><a href="https://youtu.be/AxO8iduHoNA?si=NnzWOMTXhCGvvD7_"><img src="https://img.youtube.com/vi/AxO8iduHoNA/maxresdefault.jpg" alt="Selling Copilot for Security w/ Multi-stage Incident Demo" width="400" height="400"></a></td>
    <td><a href="https://youtu.be/AxO8iduHoNA?si=NnzWOMTXhCGvvD7_"><b>Selling Copilot for Security w/ Multi-stage Incident Demo</b></a><br><br>Explore Copilot for Security’s powerful use cases, its unique value, proven results, and differentiation story, and see it all in action with a comprehensive multi-stage incident demo in Microsoft Defender XDR.</td>
  </tr>
  <tr style="vertical-align:top">
   <td><a href="https://youtu.be/DSL-nPWUXlY?si=NSQvyGyhMakPGLZX"><img src="https://img.youtube.com/vi/DSL-nPWUXlY/maxresdefault.jpg" alt="Copilot for Security Responsible AI
" width="400" height="400"></a></td>
  ...
  <tr style="vertical-align:top">
   <td><a href="https://youtu.be/0lg_derTkaM"><img src="https://img.youtube.com/vi/0lg_derTkaM/hqdefault.jpg" alt="How Microsoft Copilot for Security works" width="400" height="400"></a></td>
...
* [Join the Copilot for Security Customer Connection Program (CCP)](https://www.aka.ms/prseccom)
