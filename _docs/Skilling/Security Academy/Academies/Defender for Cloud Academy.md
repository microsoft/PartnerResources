...
<table>
  ...
  <tr style="vertical-align:top">
    ...
    <td><a href="https://youtu.be/p8sc8NaSe8U"><b>Cloud Workload Protection Capabilities</b></a><br><br>Learn the importance of CWP capabilities with Microsoft Defenders for DNS, Key Vault, Servers, Storage, and SQL Servers. Explore vulnerability assessments, adaptive app controls, network hardening, Just-in-Time (JIT) access, file integrity, and Azure Lighthouse.</td>
  </tr>
  <tr style="vertical-align:top">
